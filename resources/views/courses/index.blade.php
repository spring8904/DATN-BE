        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Quản lí khóa học</h4>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control form-control-sm" name="code" type="text"
                                        value="{{ request()->input('code') ?? '' }}" placeholder="Nhập mã khóa học..."
                                        data-advanced-filter>
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">Tên khóa học</label>
                                    <input class="form-control form-control-sm" name="name" type="text"
                                        value="{{ request()->input('name') ?? '' }}" placeholder="Nhập tên khóa học..."
                                        data-advanced-filter>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select form-select-sm" name="level" id="statusItem"
                                        ...
                                        <option @selected(request()->input('level') === 'beginner') value="beginner">Cơ bản</option>
                                        <option @selected(request()->input('level') === 'intermediate') value="intermediate">Trung cấp</option>
                                ...
                                <div class="col-md-3 mt-2">
                                    ...
                                    <select class="form-select form-select-sm" name="status" id="statusItem"
                                        ...
                                        <option @selected(request()->input('status') === 'pending') value="draft">Đang chờ duyệt</option>
                                        <option @selected(request()->input('status') === 'approved') value="approved">Được phê duyệt</option>
                                        <option @selected(request()->input('status') === 'rejected') value="rejected">Bị từ chối</option>
